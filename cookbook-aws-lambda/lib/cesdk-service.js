  ...
  constructor(scope, id) {
    ...
    const cesdkHandler = new lambda.Function(this, "CESDKHandler", {
      ...
      environment: {
        ...
        TEMPLATE_URL: "https://img.ly/showcases/cesdk/web/cases/headless-design/example.scene"
      },
    ...
    const imagesTablePermissions = new iam.Policy(this, `${this.appName}-ImagesTablePermissions`, {
    ...
    cesdkHandler.addEventSource(new eventsource.DynamoEventSource(imagesTable, {
